...
from core.config import STARTING_BALANCE
...
class Wallet:
    ...
    def verify(public_key, data, signature):
        ...
        # Signature is randomly generated in 2 parameters.
        (r, s) = signature
    ...
    def calculate_balance(blockchain, address):
        """
        Calculate the balance of the given wallet address.
        Considering the transaction data in the blockchain.
        
        The balance is found by adding the output values that
        belong to the address since the most recent transaction by that adress.
        """

...
pnconfig.subscribe_key = 'sub-c-ac52c748-7747-11ea-808e-bad180999bc3'
pnconfig.publish_key = 'pub-c-9e79f647-7022-4ca9-928d-af6b270007e8'
...
class PubSub():
    ...
    Provides communication between the nodes of the blockchain application.
    """
    def __init__(self, blockchain, transaction_pool):
